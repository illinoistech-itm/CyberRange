...
# OAuth configuration
# client_id = '132699377429-jvlcuptes24aj1rosv6l555bp6pmaejd.apps.googleusercontent.com'
# client_secret = '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'
client_id = os.getenv('CLIENT_ID')
client_secret = os.getenv('CLIENT_SECRET')
authorization_base_url = 'https://accounts.google.com/o/oauth2/auth'
token_url = 'https://accounts.google.com/o/oauth2/token'
redirect_uri = 'https://system77.rice.iit.edu:5000/callback'
scope = ['profile', 'email']
...
if __name__ == '__main__':
    app.run(debug=True, ssl_context=('cert.pem', 'private_key.pem'), host='192.168.172.82', port=5000)
