...
sudo apt install -y python3-flask-socketio python3-requests python3-hvac python3-dotenv python3-proxmoxer python3-flask-sqlalchemy python3-fabric python3-paramiko python3-metaconfig python3-flask-cors python3-minio
