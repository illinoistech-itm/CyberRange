...
sudo apt install -y python3-flask-socketio python3-flask-login python3-requests python3-requests-oauthlib python3-hvac python3-dotenv python3-paramiko python3-jinja2 python3-metaconfig python3-flask-sqlalchemy python3-toml
