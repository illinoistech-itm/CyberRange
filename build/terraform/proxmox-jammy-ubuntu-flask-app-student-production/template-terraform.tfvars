...
###############################################################################
# Provide integration with Vault
# https://stackoverflow.com/questions/47309229/fetching-vault-secret-value-using-terraform?rq=3
...
pm_timeout    = 800                            # (Optional; defaults to 300) Timeout value (seconds) for proxmox API calls.
