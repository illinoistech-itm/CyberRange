...
###############################################################################
keypath = "nid_ed25519_ca_server_connect_key" # The name to the private key you need to communicate with your instances
###############################################################################
...
###############################################################################
yourinitials                     = "cyberrange-ca"                     # Value needs to match the root URL of the FLASK_API_SERVER value you set in Vault
numberofvms                      = 1                      # quantity of that template to launch
desc                             = "CA server for cyberrange ITMT 430 spring project"                     # What is the purpose of the TF template
...
# instances from
###############################################################################
template_to_clone = "cyber-range-ca-template" # The name of the template to clone
tags              = "cyberrange,caserver" # Tags separated by commas: be,team00
###############################################################################
