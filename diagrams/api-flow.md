...
1. Once authenticated user account on local database iscreated or current account has login process logged
...
```mermaid
sequenceDiagram
    WebApp ->> Buildserver: Hello Buildserver, how are you?
